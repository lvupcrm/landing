...
export default function WebinarLandingPage() {
  return (
    <div className="flex flex-col items-center min-h-screen bg-gray-900 text-white">
      {/* Hero Section */}
      <section id="hero" className="w-full bg-gray-900 text-center py-16 sm:py-20 md:py-24 px-4 relative">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-6 text-gray-300">
            『피트니스 노션 × AI 업무 자동화』 무료 웨비나
          </h2>
          
          <p className="text-lg sm:text-xl mb-8 text-gray-400 max-w-3xl mx-auto leading-relaxed">
            실제 센터 대표가 만든 시스템으로 운영 자동화를 경험하세요.
          </p>
          
          {/* AI Tools Grid */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10 max-w-2xl mx-auto">
            <div className="bg-gray-800 rounded-xl p-4 shadow-lg border border-gray-700 hover:shadow-xl transition-all duration-300">
              <div className="text-3xl mb-2">📝</div>
              <div className="text-sm font-semibold text-gray-300">Notion</div>
            </div>
            <div className="bg-gray-800 rounded-xl p-4 shadow-lg border border-gray-700 hover:shadow-xl transition-all duration-300">
              <div className="text-3xl mb-2">🤖</div>
            ...
            <div className="bg-gray-800 rounded-xl p-4 shadow-lg border border-gray-700 hover:shadow-xl transition-all duration-300">
              <div className="text-3xl mb-2">⚡</div>
              <div className="text-sm font-semibold text-gray-300">Make</div>
            </div>
            <div className="bg-gray-800 rounded-xl p-4 shadow-lg border border-gray-700 hover:shadow-xl transition-all duration-300">
              <div className="text-3xl mb-2">🔧</div>
              <div className="text-sm font-semibold text-gray-300">Automation</div>
            </div>
          </div>
          ...
          <div className="mt-8 space-y-2 text-gray-400">
            <p className="flex items-center justify-center gap-2">
              <span className="text-blue-400">📅</span> 일시: 2025년 7월 25일(금) 오후 3시
            </p>
            <p className="flex items-center justify-center gap-2">
      ...
      {/* 공감 & 문제 제기 섹션 */}
      <section id="problem" className="w-full py-20 md:py-24 px-4 bg-gray-900">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-400 mb-6">
              다음은 피트니스 센터 운영자들이 겪는 어려움입니다
            </p>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-green-500 rounded-full mx-auto"></div>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-800 rounded-2xl p-8 border border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="text-center mb-6">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-500 rounded-full mb-4">
                  <span className="text-2xl text-white">❌</span>
                </div>
                <h3 className="text-xl font-bold text-white mb-3">작업물 유실</h3>
                <p className="text-gray-400 leading-relaxed">손으로, 기억력으로 관리하기엔 너무 벅차고, 하루하루가 똑같이 반복되기만 하고, 매달 이러면 안 된다는 걸 알지만 바뀌는 건 없고…</p>
              </div>
            </div>
            ...
            <div className="bg-gray-800 rounded-2xl p-8 border border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="text-center mb-6">
                ...
                <h3 className="text-xl font-bold text-white mb-3">학습의 어려움</h3>
                <p className="text-gray-400 leading-relaxed">노션과 AI를 활용하고 싶지만 독학하기엔 너무 어려워서 포기하게 되는 경우가 많습니다.</p>
              </div>
            </div>
            ...
            <div className="bg-gray-800 rounded-2xl p-8 border border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="text-center mb-6">
                ...
                <h3 className="text-xl font-bold text-white mb-3">작업의 연속성</h3>
                <p className="text-gray-400 leading-relaxed">집에서 하던 작업을 외부에서 이어가기 위해 파일을 이메일로 주고받는 불편함</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* 강의자 소개 섹션 */}
      <section id="instructor" className="w-full py-20 md:py-24 px-4 bg-gray-900">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-white font-semibold text-lg">센터 2개 지점 운영</span>
                </div>
                <div className="flex items-center gap-4">
                  <span className="text-3xl">🚀</span>
                  <span className="text-white font-semibold text-lg">피트니스 종사자 성장 플랫폼 LVUP 운영</span>
                </div>
                <div className="flex items-center gap-4">
                  <span className="text-3xl">🤖</span>
                  <span className="text-white font-semibold text-lg">Notion, GPT, Make를 활용한 피트니스 운영 자동화 전문가</span>
                </div>
                <div className="flex items-center gap-4">
                  <span className="text-3xl">📈</span>
                  <span className="text-white font-semibold text-lg">센터운영 10년차 대표가 경험한 내용을 솔루션으로 개발</span>
                </div>
              </div>
              
              <div className="bg-gradient-to-br from-blue-900/50 to-purple-900/50 rounded-2xl p-8 border border-blue-700 flex items-center">
      ...
      {/* 웨비나에서 배울 수 있는 내용 */}
      <section id="content" className="w-full py-20 md:py-24 px-4 bg-gray-900">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-white mb-4 leading-tight">
              웨비나 내용 한눈에 보기
      ...
      {/* 참가 혜택 강조 섹션 */}
      <section id="benefits" className="w-full py-20 md:py-24 px-4 bg-gray-900">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-800 rounded-2xl p-6 border border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300 group hover:scale-105">
              <div className="text-center">
                ...
                <h3 className="font-bold text-white mb-3 text-lg">운영 자동화 전체 흐름도 PDF</h3>
                <p className="text-gray-400 leading-relaxed text-sm">센터 운영 자동화의 전체적인 구조와 흐름을 한눈에 파악할 수 있는 가이드</p>
              </div>
            </div>
            ...
            <div className="bg-gray-800 rounded-2xl p-6 border border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300 group hover:scale-105">
              <div className="text-center">
                ...
                <h3 className="font-bold text-white mb-3 text-lg">상담/고객 관리용 Notion 템플릿</h3>
                <p className="text-gray-400 leading-relaxed text-sm">바로 사용할 수 있는 실용적인 노션 템플릿 제공</p>
              </div>
            </div>
            ...
            <div className="bg-gray-800 rounded-2xl p-6 border border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300 group hover:scale-105">
              <div className="text-center">
                ...
                <h3 className="font-bold text-white mb-3 text-lg">센터 운영에 도움 되는 커스텀 GPT</h3>
                <p className="text-gray-400 leading-relaxed text-sm">피트니스 센터 운영에 특화된 AI 어시스턴트 활용법</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* 실제 변화 및 후기 */}
      <section id="testimonials" className="w-full py-20 md:py-24 px-4 bg-gray-900">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-800 rounded-2xl p-6 border border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-bold text-white mb-2 text-lg">"출근 하지 않아도 센터 운영을 할 수 있게 되었습니다."</p>
                  <p className="text-gray-400">- 자동화 시스템 구축 후</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800 rounded-2xl p-6 border border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-start gap-4">
                <span className="text-4xl">💬</span>
                <div>
                  <p className="font-bold text-white mb-2 text-lg">"직원과 카톡 조율이 사라졌습니다."</p>
                  <p className="text-gray-400">- 자동화된 커뮤니케이션</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800 rounded-2xl p-6 border border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-start gap-4">
                <span className="text-4xl">👥</span>
                <div>
                  <p className="font-bold text-white mb-2 text-lg">"고객 관리가 자동으로 되니 누락 걱정이 없습니다."</p>
                  <p className="text-gray-400">- 체계적인 고객 관리</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* LVUP 브랜드 소개 */}
      <section id="brand" className="w-full py-20 md:py-24 px-4 bg-gray-900">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
          ...
          <div className="bg-gray-800 rounded-2xl p-8 md:p-12 shadow-xl border border-gray-700">
            <div className="text-center mb-10">
              <div className="flex items-center justify-center gap-4 mb-8">
                <span className="text-5xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">LVUP</span>
              </div>
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-6 text-white leading-relaxed">더 쉽게 일하고, 강력하게 성장하는<br />피트니스 업무 시스템</h3>
              <p className="text-gray-400 mb-8 text-lg leading-relaxed max-w-4xl mx-auto">
            ...
            <div className="space-y-4 mb-12 max-w-3xl mx-auto">
              <div className="flex items-center gap-4">
                ...
                <span className="text-white text-lg">노션 기반, 클릭 한 번으로 복제</span>
              </div>
              <div className="flex items-center gap-4">
                <span className="text-blue-400 text-xl">✔️</span>
                <span className="text-white text-lg">회원/직원/매출/마케팅 등 센터 운영 전반 지원</span>
              </div>
              <div className="flex items-center gap-4">
                <span className="text-blue-400 text-xl">✔️</span>
                <span className="text-white text-lg">누구나 쉽게 적응, 완전한 커스터마이징 가능</span>
              </div>
              <div className="flex items-center gap-4">
                <span className="text-blue-400 text-xl">✔️</span>
                <span className="text-white text-lg">성장에 도움이 되는 블로그/자료 제공</span>
              </div>
            </div>
      ...
      {/* 추천 대상 */}
      <section id="recommend" className="w-full py-20 md:py-24 px-4 bg-gray-900">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gray-800 rounded-2xl p-6 border border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300 group hover:scale-105">
              <div className="flex items-center gap-6">
                ...
                <div>
                  <div className="font-bold text-white text-xl mb-2">피트니스 센터 운영자</div>
                  <div className="text-gray-400 text-lg">업무 효율성을 높이고 싶은 분</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800 rounded-2xl p-6 border border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300 group hover:scale-105">
              <div className="flex items-center gap-6">
                <span className="text-4xl flex-shrink-0 group-hover:scale-110 transition-transform">📱</span>
                <div>
                  <div className="font-bold text-white text-xl mb-2">디지털 전환 희망자</div>
                  <div className="text-gray-400 text-lg">노션과 AI를 활용하고 싶은 분</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800 rounded-2xl p-6 border border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300 group hover:scale-105">
              <div className="flex items-center gap-6">
                <span className="text-4xl flex-shrink-0 group-hover:scale-110 transition-transform">⚡</span>
                <div>
                  <div className="font-bold text-white text-xl mb-2">업무 자동화 희망자</div>
                  <div className="text-gray-400 text-lg">반복 업무를 줄이고 싶은 분</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800 rounded-2xl p-6 border border-gray-700 shadow-lg hover:shadow-xl transition-all duration-300 group hover:scale-105">
              <div className="flex items-center gap-6">
                <span className="text-4xl flex-shrink-0 group-hover:scale-110 transition-transform">🚀</span>
                <div>
                  <div className="font-bold text-white text-xl mb-2">성장 지향적 분</div>
                  <div className="text-gray-400 text-lg">센터 운영을 혁신하고 싶은 분</div>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* 마지막 CTA Section */}
      <section id="cta" className="w-full py-20 md:py-24 px-4 bg-gray-900 text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-black mb-8 text-white leading-tight">
            📢 지금 신청하면, 다음 달이 달라집니다!
          </h2>
          ...
          <div className="space-y-6 mb-12">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-lg">
              <div className="flex items-center gap-3">
                ...
                <span>참가비: <span className="font-bold text-blue-400">무료</span></span>
              </div>
              <div className="flex items-center gap-3">
          ...
          <div className="bg-gray-800 rounded-2xl p-8 md:p-12 shadow-xl border border-gray-700">
            <div className="flex items-center justify-center gap-6 mb-8">
              ...
              <span className="text-3xl font-bold text-blue-400">무료</span>
            </div>
      ...
      {/* Footer */}
      <footer className="w-full text-center text-gray-400 py-12 bg-gray-800 border-t border-gray-700">
